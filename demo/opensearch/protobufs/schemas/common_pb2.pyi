...
class QueryContainer(_message.Message):
    __slots__ = ("bool", "constant_score", "function_score", "exists", "fuzzy", "ids", "prefix", "range", "regexp", "term", "terms", "terms_set", "wildcard", "match", "match_bool_prefix", "match_phrase", "match_phrase_prefix", "multi_match", "knn", "match_all", "match_none", "nested", "geo_distance", "geo_bounding_box", "script", "hybrid", "boosting", "simple_query_string")
